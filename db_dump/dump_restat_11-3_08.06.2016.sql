...
-- Дамп данных таблицы restat_11-3.refill: ~4 rows (приблизительно)
...
INSERT INTO `refill` (`id`, `id_user`, `date`, `time`, `odometr`, `total_sum`, `total_liters`, `price_gas`, `fuel_type`, `id_zapravki`) VALUES
	...
	(26, 2, '2016-06-08', '03:11:00', 123, 1, 1, 1, 'gas', '1'),
	(27, 2, '2016-06-08', '03:39:00', 123, 100, 13, 7.69, 'gas', '');
...
-- Дамп данных таблицы restat_11-3.service_intervals: ~16 rows (приблизительно)
